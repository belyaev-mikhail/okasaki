...
import ru.spbstu.collections.persistent.SZipper
import ru.spbstu.collections.persistent.iterator
import java.util.*
...
fun <E> SList<E>?.drop(index: Int): SList<E>? =
        if (index == 0) this
        else (0..(index - 1)).fold(this) { l, _ -> l?.tail }
